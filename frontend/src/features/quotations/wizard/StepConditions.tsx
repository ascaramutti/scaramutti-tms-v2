...
/**
 * Paso 4 (opcional): elige con checkboxes las CONDICIONES GENERALES que aplican a la cotización.
 * En creación, las activas vienen pre-marcadas (RN-07; el pre-check lo hace WizardForm en los
 * defaults). La selección vive en el form (`conditionIds`); este paso solo la lee/escribe.
 *
