    ...
    <Card padding="md">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-12">
        <div className="lg:col-span-6">
          <label htmlFor="entries-q" className="mb-1.5 block text-sm font-medium text-fg-body">
            Buscar
          </label>
          ...
          {showSearchHint && (
            <p id="entries-q-hint" className="mt-1 text-xs text-fg-muted">
      ...
      {invalidRange && (
        <p id="entries-date-error" role="alert" className="mt-3 text-xs text-danger">
