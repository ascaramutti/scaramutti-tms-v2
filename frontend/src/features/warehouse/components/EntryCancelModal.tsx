...
import { entryCancelSchema, type EntryCancelInput } from '../schemas/entry-cancel.schema'
...
function EntryCancelForm({ onClose, invoice, onReloadRequested }: EntryCancelModalProps) {
  ...
  } = useForm<EntryCancelInput>({
    resolver: zodResolver(entryCancelSchema),
    mode: 'onTouched',
  ...
  function onSubmit(input: EntryCancelInput) {
