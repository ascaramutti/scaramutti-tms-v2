...
/**
 * Integration tests de GET/POST /warehouse/product-categories.
 * Calco estructural de CargoTypesResourceTest (catalogo GET+POST con
 * duplicado 409). Los seeds de A1 (7 categorias activas) ya estan en la BD
 * de test — no se re-siembran acá.
 */
@QuarkusTest
