...
/**
 * Unit tests del service. Calco de CargoTypeServiceTest: aisla la logica de
 * IO de BD con mocks. Los integration tests
 * (WarehouseProductCategoriesResourceTest) cubren el end-to-end con BD real.
 */
