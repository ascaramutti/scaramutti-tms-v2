...
public class WarehouseSupplierResource {
    ...
    @RolesAllowed({"admin", "general_manager", "operations_manager", "finance_manager", "warehouse_keeper"})
    @ResponseStatus(201)
    public WarehouseSupplierResponse createSupplier(@Valid @NotNull WarehouseSupplierRequest warehouseSupplierRequest) {
        return warehouseSupplierService.createSupplier(
            warehouseSupplierResourceMapper.toCreateWarehouseSupplierCommand(warehouseSupplierRequest)
        );
    }
}
