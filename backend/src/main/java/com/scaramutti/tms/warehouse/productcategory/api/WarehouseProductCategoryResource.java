...
public class WarehouseProductCategoryResource {
    ...
    @RolesAllowed({"admin", "general_manager", "operations_manager", "finance_manager", "warehouse_keeper"})
    @ResponseStatus(201)
    public WarehouseProductCategoryResponse createProductCategory(@Valid @NotNull WarehouseProductCategoryRequest warehouseProductCategoryRequest) {
        return warehouseProductCategoryService.createProductCategory(
            warehouseProductCategoryResourceMapper.toCreateWarehouseProductCategoryCommand(warehouseProductCategoryRequest)
        );
    }
}
